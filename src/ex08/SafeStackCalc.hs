...
data SProg a b c where
    ...
    Pop  :: SProg a b NonEmpty -> SProg b c d
    Push :: Int -> SProg b c d -> SProg Int b NonEmpty
    Dup  :: SProg a b c -> SProg a a NonEmpty
    Dup2 :: SProg a b c -> SProg a b NonEmpty
    Flip :: SProg a b NonEmpty -> SProg a b NonEmpty
    Add  :: SProg Int Int NonEmpty -> SProg Int a NonEmpty
    Sub  :: SProg Int Int NonEmpty -> SProg Int a NonEmpty
    Mul  :: SProg Int Int NonEmpty -> SProg Int a NonEmpty
    Leq  :: SProg Int Int NonEmpty -> SProg Bool a NonEmpty
    Geq  :: SProg Int Int NonEmpty -> SProg Bool a NonEmpty
    Not  :: SProg Bool a NonEmpty -> SProg Bool a NonEmpty
    And  :: SProg Bool Bool NonEmpty -> SProg Bool a NonEmpty
    Or   :: SProg Bool Bool NonEmpty -> SProg Bool a NonEmpty
...
evalAritOp :: (Int -> Int -> Int) -> SProg Int Int NonEmpty -> [Value]
evalAritOp op s =
    let xs    = eval s
        (I a) = head xs
        (I b) = head $ tail xs
...
evalCompOp :: (Int -> Int -> Bool) -> SProg Int Int NonEmpty -> [Value]
evalCompOp op s =
    let xs    = eval s
        (I a) = head xs
        (I b) = head $ tail xs
...
evalLogicOp :: (Bool -> Bool -> Bool) -> SProg Bool Bool NonEmpty -> [Value]
evalLogicOp op s =
    let xs    = eval s
        (B a) = head xs
        (B b) = head $ tail xs
